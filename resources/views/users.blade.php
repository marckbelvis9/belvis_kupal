<x-app-layout>
    ...
    <div class="py-12 bg-gray-100 dark:bg-blue-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-blue-800 shadow-lg sm:rounded-lg overflow-hidden">
                <div class="p-6">
                    <!-- New User Button -->
                    @if (session('message'))
                        <p>{{ session('message') }}</p>
                    ...
                    <table class="min-w-full table-auto border-collapse">
                        <thead>
                            <tr class="bg-gray-200 dark:bg-purple-700 text-left text-sm leading-normal">
